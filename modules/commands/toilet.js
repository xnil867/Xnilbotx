...
try {
  ...
  const canvas = Canvas.createCanvas(500, 670);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "অতিরিক্ত বাল পাকনামির কারনে তোরে টয়লেটে ফেলে দিলাম🥀🤖"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
