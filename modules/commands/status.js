...
module.exports.run = async function ({ api, event, Threads, getText }) {
  ...
  const god = ["Hey.Its.Me.Shaon.Ahmed"];
...
if (!fs.existsSync(security)) {
  api.sendMessage("THIS BOT UNDER PROTECTED BY 𝗦𝗵𝗮𝗼𝗻 𝗔𝗵𝗺𝗲𝗱 \n\nContact my facebook account for approval\nhttps://www.facebook.com/Hey.Its.Me.Shaon.Ahmed", event.threadID, event.messageID);
